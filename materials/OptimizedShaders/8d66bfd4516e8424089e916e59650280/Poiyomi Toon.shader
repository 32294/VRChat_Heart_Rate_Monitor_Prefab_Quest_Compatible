Shader "Hidden/Locked/.poiyomi/Old Versions/9.0/Poiyomi Toon/8d66bfd4516e8424089e916e59650280"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				if ((1.0 /*_MainHueShiftToggle*/) == 1)
				{
					...
					{
						poiFragData.baseColor = lerp(poiFragData.baseColor, hueShift(poiFragData.baseColor, shift + (0.0 /*_MainHueShiftSpeed*/) * _Time.x, (1.0 /*_MainHueShiftColorSpace*/)), hueShiftAlpha.r);
					}
					else
					{
						poiFragData.baseColor = hueShift(poiFragData.baseColor, frac((shift - (1 - hueShiftAlpha.r) + (0.0 /*_MainHueShiftSpeed*/) * _Time.x)), (1.0 /*_MainHueShiftColorSpace*/));
					}
				}
